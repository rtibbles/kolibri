/**
 * SCORM API shim for HTML5 zip content.
 *
...
export default class SCORMShim extends SandboxShim {
  ...
  getProgress() {
    const score = getByKeyPath(this.data, 'cmi.core.score', SCHEMA, this.userData);
    if (score) {
    ...
    const lessonStatus = getByKeyPath(this.data, 'cmi.core.lesson_status', SCHEMA, this.userData);
