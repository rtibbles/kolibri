...
export default function(H5PIntegration, window, document, H5PEditor) {
  window.jQuery = jQuery;

  // Add this back in for for backwards compatibility.
  // Dropped in jQuery 1.8
  ...
  H5P.init = function(target) {
    ...
    H5P.jQuery('.h5p-content:not(.h5p-initialized)', target).each(function() {
      ...
      if (H5P.isFramed) {
        ...
        if (H5P.externalEmbed === false) {
          // Internal embed
          // Make it possible to resize the iframe when the content changes size.
      ...
      if (!H5P.isFramed || H5P.externalEmbed === false) {
        ...
        H5P.jQuery(window.parent).resize(function() {
          if (window.parent.H5P.isFullscreen) {
            // Use timeout to avoid bug in certain browsers when exiting fullscreen.
            // Some browser will trigger resize before the fullscreenchange event.
            H5P.trigger(instance, 'resize');
          } else {
            H5P.trigger(instance, 'resize');
          }
    ...
    H5P.jQuery('iframe.h5p-iframe:not(.h5p-initialized)', target).each(function() {
      ...
      const language =
        contentData && contentData.metadata && contentData.metadata.defaultLanguage
  ...
  (function() {
     ...
     *
     * @param {Object|string} source File object from parameters/json_content
    ...
    H5P.getCrossOrigin = function(source) {
      if (typeof source !== 'object') {
        ...
        return H5PIntegration.crossorigin &&
          ...
          source.match(H5PIntegration.crossoriginRegex)
        ...
        if (
          ...
          if (value.width !== undefined && value.height !== undefined) {
            copyrights.setThumbnail(
              new H5P.Thumbnail(H5P.getPath(value.path, contentId), value.width, value.height)
            );
          }
        ...
        var expand = function() {
          ...
          if ($content.is(':visible')) {
            $expander
              ...
              .text(H5P.t('showAdvanced'))
              .attr('aria-expanded', 'true');
            $content.hide();
          } else {
            $expander
              .addClass('h5p-open')
              .text(H5P.t('hideAdvanced'))
  ...
  H5P.MediaCopyright = function(copyright, labels, order, extraFields) {
    ...
    var humanizeLicense = function(license, version) {
      ...
      if (!(license === 'PD' && version)) {
        // Add license label
        value += Object.prototype.hasOwnProperty.call(copyrightLicense, 'label')
      ...
      if (versionInfo) {
        ...
        value += Object.prototype.hasOwnProperty.call(versionInfo, 'label')
          ? versionInfo.label
          : versionInfo;
      }
      ...
      var link;
      if (Object.prototype.hasOwnProperty.call(copyrightLicense, 'link')) {
        link = copyrightLicense.link.replace(
          ':version',
          copyrightLicense.linkVersions ? copyrightLicense.linkVersions[version] : version
        );
      } else if (versionInfo && Object.prototype.hasOwnProperty.call(copyrightLicense, 'link')) {
    ...
    if (copyright !== undefined) {
      ...
      for (var field in extraFields) {
        if (Object.prototype.hasOwnProperty.call(extraFields, field)) {
        ...
        if (copyright[fieldName] !== undefined && copyright[fieldName] !== '') {
          ...
          if (fieldName === 'source') {
            humanValue = humanValue
              ? '<a href="' + humanValue + '" target="_blank">' + humanValue + '</a>'
              : undefined;
          }
  ...
  H5P.getLibraryPath = function(library) {
    if (H5PIntegration.urlLibraries !== undefined) {
      // This is an override for those implementations that has a different libraries URL
  ...
  H5P.shuffleArray = function(array) {
    // TODO: Consider if this should be a part of core.
    // I'm guessing very few libraries are going to use it.
  ...
  (function($) {
    ...
    H5P.ClipboardItem = function(parameters, genericProperty, specificKey) {
      ...
      if (H5PEditor && H5PEditor.contentId) {
      ...
      recursiveUpdate(clipboardData.specific, function(path) {
        ...
        if (!isTmpFile && clipboardData.contentId && !path.match(/^https?:\/\//i)) {
          ...
          if (H5PEditor.contentId) {
            ...
            // .. to new content
            return (
              (H5PEditor.contentRelUrl ? H5PEditor.contentRelUrl : '../content/') +
    ...
    var recursiveUpdate = function(params, handler) {
      for (var prop in params) {
        if (Object.prototype.hasOwnProperty.call(params, prop) && params[prop] instanceof Object) {
          var obj = params[prop];
